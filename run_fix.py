...
# 1) Tap Assignment Route Proxy
api_dir = r"C:\MotionHR\web\src\app\api\hr\shifts\assignments"
...
export async function GET(request: Request) {
  ...
  try {
    const res = await fetch(`${BACKEND}/attendance/api/mobile/manager/shifts/assignments/`, {
...
# 2) Full Dynamic Shifts Page
page_path = r"C:\MotionHR\web\src\app\hr\shifts\page.tsx"
...
print("✅ Complete Shifts Page and API Proxy created successfully!")
