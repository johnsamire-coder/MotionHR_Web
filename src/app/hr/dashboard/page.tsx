...
export default function HRDashboardPage() {
  ...
  const statCards = [
    ...
    },
    {
      ...
      value: loading ? "..." : (stats?.present_today ?? 0).toLocaleString(lang === "ar" ? "ar-EG" : "en-US"),
      change: lang === "ar" ? "اليوم" : "Today",
      trend: "up" as const,
      icon: UserCheck,
    ...
    {
      title: d.onLeave,
      value: loading ? "..." : (stats?.on_leave ?? 0).toLocaleString(lang === "ar" ? "ar-EG" : "en-US"),
      change: lang === "ar" ? "هذا الشهر" : "This month",
    ...
    },
    {
      ...
      value: loading ? "..." : (stats?.pending_requests ?? 0).toLocaleString(lang === "ar" ? "ar-EG" : "en-US"),
      change: lang === "ar" ? "بانتظار المراجعة" : "Awaiting review",
      trend: "neutral" as const,
      icon: Clock,
